...
GLFWwindow* ViewManager::CreateDisplayWindow(const char* windowTitle)
{
	...
	//callback for Scroll Wheel Movement
...
void ViewManager::Scroll_Callback(GLFWwindow* window, double xoffset, double yoffset)
{
	...
	if (g_pCamera->MovementSpeed < 2.0f)
		g_pCamera->MovementSpeed = 2.0f; // Prevent MovementSpeed from going below 2.0
	if (g_pCamera->MovementSpeed > 50.0f)
		g_pCamera->MovementSpeed = 50.0f;// Prevent MovementSpeed from going above 50.0
}
/***********************************************************
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	//process camera moving up and down with Q and E
