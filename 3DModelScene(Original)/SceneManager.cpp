...
void SceneManager::LoadSceneTextures() {
	...
	bReturn = CreateGLTexture("C:/CS330Content/CS330Content/Projects/7-1_FinalProjectMilestones/textures/BlueBook.jpg", "BlueBook");

	bReturn = CreateGLTexture("C:/CS330Content/CS330Content/Projects/7-1_FinalProjectMilestones/textures/PinkBook.jpg", "PinkBook");

	bReturn = CreateGLTexture("C:/CS330Content/CS330Content/Projects/7-1_FinalProjectMilestones/textures/PostItNote.jpg", "PostItNote");
...
void SceneManager::DefineObjectMaterials()
{
	...
	shineMaterial.ambientStrength = 0.4f;
	shineMaterial.diffuseColor = glm::vec3(1.0f, 1.0f, 1.0f);
	shineMaterial.specularColor = glm::vec3(0.6f, 0.5f, 0.4f);
	shineMaterial.shininess = 2.0;
	...
	flatMaterial.ambientStrength = 0.3f;
	flatMaterial.diffuseColor = glm::vec3(0.8f, 0.8f, 0.8f);
	flatMaterial.specularColor = glm::vec3(0.2f, 0.2f, 0.4f);
	flatMaterial.shininess = 0.1;
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[1].position", 0.0f, 50.0f, 10.0f);
	m_pShaderManager->setVec3Value("lightSources[1].ambientColor", 0.01f, 0.01f, 0.01f);
	m_pShaderManager->setVec3Value("lightSources[1].diffuseColor", 1.0f, 0.0f, 0.0f);
	...
	m_pShaderManager->setFloatValue("lightSources[1].specularIntensity", 1.05f);

	m_pShaderManager->setVec3Value("lightSources[2].position", 7.0f, -10.0f, 6.0f);
